...
lbl_noon=Label(root,text="AM",font=("times new roman",50,"bold"),bg="green",fg="white")
lbl_noon.place(x=860,y=200,width=150,height=150)

lbl_noon2=Label(root,text="NOON",font=("times new roman",20,"bold"),bg="green",fg="white")
